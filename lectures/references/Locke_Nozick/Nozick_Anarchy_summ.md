...
### **[1] 전유의 경계 문제**
- **논제(Thesis Statement):**  
  - 로크의 노동 혼합 이론이 전유의 경계를 설정하는 명확한 기준을 제시하지 못한다.  
- **주요 논거(Supporting Arguments):**  
  - 노동이 섞인 대상의 범위가 어디까지인지 불분명하다.  
    - **사례:**  
      - 우주비행사가 화성을 개척하면 행성 전체를 소유하는가, 아니면 특정 지역만 소유하는가?  
...
### **[2] 노동 혼합이 왜 소유권을 발생시키는가?**
- **논제(Thesis Statement):**  
  - 노동 혼합이 소유권을 정당화하는 논리는 일관성이 없으며, 반드시 소유권 확립으로 이어지는 것은 아니다.  
- **주요 논거(Supporting Arguments):**  
  - 노동을 섞었다고 해서 소유권이 발생한다고 보는 것은 문제가 있다.  
    - **사례:**  
      - 토마토 주스를 바다에 쏟았다고 해서 바다를 소유하게 되는 것은 아니다.  
  - 노동이 가치를 증가시키는 것이 소유권의 정당화 근거라면, 가치가 감소할 경우(예: 드리프트 우드에 분홍색 페인트를 칠하는 경우)에는 소유권이 부정되어야 한다.  
  - 노동이 불쾌한 행위라서 소유를 정당화한다고 하면, 노력이 덜 드는 경우(예: *The Yellow Submarine*의 캐릭터들이 꽃을 흩뿌리는 것처럼 무심코 창조하는 경우)에는 소유권 주장이 약해지는가?  
  - 현재까지 일관된 "가치 증가 기반의 전유 이론"이 존재하지 않으며, 헨리 조지(Henry George)의 토지세 이론이 비판받은 것과 유사한 문제에 직면할 것이다.  

### **[3] 제한된 자원과 전유의 영향**
- **논제(Thesis Statement):**  
  - 전유가 발생할 때 타인의 자유가 제한될 가능성이 있으며, 이는 반드시 그들의 상황을 악화시키는 것은 아니다.  
- **주요 논거(Supporting Arguments):**  
  - 이전에는 자유롭게 사용할 수 있었던 자원이 전유를 통해 사용이 제한될 수 있다.  
  - 하지만, 특정 자원의 전유가 반드시 타인의 상황을 악화시키는 것은 아니다.  
    - **사례:**  
      - 코니 아일랜드의 모래 한 알을 전유한다고 해서 타인이 불이익을 받는 것은 아니다.  
